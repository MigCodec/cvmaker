...
<div class="py-6 max-w-2xl mx-auto p-6">
    ...
    <h1 class="text-2xl font-semibold mb-2">Nueva experiencia</h1>
    <p class="text-sm text-gray-600 mb-4">Cada puesto se guarda por separado. Usa "Guardar y agregar otra" para capturar varias experiencias seguidas.</p>
    <form method="POST" action="{{ route('cv.experiences.store') }}" class="space-y-4">
        @csrf
        @include('cv.experiences.form')
